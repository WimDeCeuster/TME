...
{
    public class WhenRequestingACarRulesKey : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            _expectedKey = "publication/" + _publicationId + "/car/" + _carID + "/rules.json";
        }

        protected override void Act()
        {
            _actualKey = _keyManager.GetCarRulesKey(_publicationId, _carID);
        }
