...
namespace TME.Carconfigurator.Tests.GivenAKeyManager
{
    public class WhenRequestingATransmissionsKey : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            _expectedKey = "publication/" + _publicationId + "/time-frame/" + _timeFrameId + "/transmissions.json";
        }

        protected override void Act()
        {
            _actualKey = _keyManager.GetTransmissionsKey(_publicationId, _timeFrameId);
        }
