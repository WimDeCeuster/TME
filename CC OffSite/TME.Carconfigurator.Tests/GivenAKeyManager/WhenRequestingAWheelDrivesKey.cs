...
{
    public class WhenRequestingAWheelDrivesKey : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            _expectedKey = "publication/" + _publicationId + "/time-frame/" + _timeFrameId + "/wheel-drives.json";
        }

        protected override void Act()
        {
            _actualKey = _keyManager.GetWheelDrivesKey(_publicationId, _timeFrameId);
        }
