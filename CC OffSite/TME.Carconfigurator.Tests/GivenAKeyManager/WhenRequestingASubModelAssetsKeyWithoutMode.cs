...
{
    public class WhenRequestingASubModelAssetsKeyWithoutMode : TestBase 
    {
        ...
        protected override void Arrange()
        {
            ...
            _expectedKey = "publication/" + _publicationId + "/submodel/" + _subModelID + "/assets/" + _objectId + "/" + _view + ".json";
        }
