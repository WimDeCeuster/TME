...
{
    public class WhenRequestingASubModelGradePacksKey : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            _expectedKey = "publication/" + _publicationID + "/time-frame/" + _timeFrameID + "/submodel/" + _submodelID + "/grade/" + _gradeID + "/packs.json";
        }

        protected override void Act()
        {
            _actualKey = _keyManager.GetSubModelGradePacksKey(_publicationID, _timeFrameID, _gradeID,_submodelID);
        }
