...
namespace TME.Carconfigurator.Tests.GivenAS3CarEquipmentPublisher
{
    ...
    {
        private ICarEquipmentPublisher _publisher;
        ...
        protected override void Arrange()
        {
            ...
            var carEquipmentService = new CarEquipmentService(_s3Service,serialiser,keymanager);
            _publisher = new CarEquipmentPublisher(carEquipmentService);
        }
