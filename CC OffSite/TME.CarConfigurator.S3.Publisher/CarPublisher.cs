...
namespace TME.CarConfigurator.S3.Publisher
{
    public class CarPublisher : ICarPublisher
    {
        ...
        public async Task PublishGenerationCarsAsync(IContext context)
        {
            if (context == null) throw new ArgumentNullException("context");

            await _timeFramePublishHelper.PublishBaseObjectList(context, timeFrame => timeFrame.Cars, _carService.PutTimeFrameGenerationCars);
        }
    }
}
