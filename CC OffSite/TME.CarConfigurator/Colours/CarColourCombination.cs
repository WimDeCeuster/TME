...
namespace TME.CarConfigurator.Colours
{
    public class CarColourCombination : ICarColourCombination
    {
        ...
        private readonly Repository.Objects.Colours.ColourCombination _repositoryColourCombination;
        ...
        public CarColourCombination(Guid carID, Repository.Objects.Colours.ColourCombination repositoryColourCombination, Publication repositoryPublication, Context repositoryContext, IColourFactory colourFactory, IAssetFactory assetFactory)
        {
