...
namespace TME.FrontEndViewer.Controllers
{
    public class ModelWheelDriveAssetsController : Controller
    {
        ...
        private static ModelWithMetrics<IReadOnlyList<IAsset>> GetOldReaderModelWithMetrics(MyContext oldContext, Guid modelID, Guid? wheelDriveID, Guid? carID)
        {
        ...
        private static ModelWithMetrics<IReadOnlyList<IAsset>> GetNewReaderModelWithMetrics(Context context, Guid modelID, Guid? wheelDriveID, Guid? carID)
        {
            var start = DateTime.Now;
