...
namespace TME.FrontEndViewer.Controllers
{
    public class ModelTransmissionVisibleInAssetsController : Controller
    {
        ...
        private static ModelWithMetrics<IAsset> GetOldReaderModelWithMetrics(MyContext oldContext, Guid modelID, Guid transmissionID, string mode, string view)
        {
        ...
        private static ModelWithMetrics<IAsset> GetNewReaderModelWithMetrics(Context context, Guid modelID, Guid transmissionID, string mode, string view)
        {
            var start = DateTime.Now;
