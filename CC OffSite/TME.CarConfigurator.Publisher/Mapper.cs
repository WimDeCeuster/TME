...
namespace TME.CarConfigurator.Publisher
{
    public class Mapper : IMapper
    {
        ...
        public Mapper(IModelMapper modelMapper, IGenerationMapper generationMapper, IBodyTypeMapper bodyTypeMapper, IEngineMapper engineMapper, ITransmissionMapper transmissionMapper, ICarMapper carMapper)
        {
