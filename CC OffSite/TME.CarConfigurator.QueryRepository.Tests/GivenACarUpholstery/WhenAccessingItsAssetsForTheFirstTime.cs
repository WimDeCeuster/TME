...
namespace TME.CarConfigurator.Query.Tests.GivenACarUpholstery
{
    public class WhenAccessingItsAssetsForTheFirstTime : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            A.CallTo(() => _assetService.GetCarAssets(publication.ID, carId, repoCarUpholstery.ID, context)).Returns(new List<Repository.Objects.Assets.Asset> { _asset1, _asset2 });
