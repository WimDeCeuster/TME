...
{
    public class WhenAccessingItsSpecificationsForTheSecondTime : TestBase
    {
        private IModelTechnicalSpecifications _firstModelSpecifications;
        private IModelTechnicalSpecifications _secondModelSpecifications;
        ...
        protected override void Arrange()
        {
            ...
            _firstModelSpecifications = _model.TechnicalSpecifications;
        }

        protected override void Act()
        {
            _secondModelSpecifications = _model.TechnicalSpecifications;
        }

        [Fact]
        public void ThenItShouldBeTheSameAsTheFirstTime()
        {
            _secondModelSpecifications.Should().BeSameAs(_firstModelSpecifications);
        }
    }
}
