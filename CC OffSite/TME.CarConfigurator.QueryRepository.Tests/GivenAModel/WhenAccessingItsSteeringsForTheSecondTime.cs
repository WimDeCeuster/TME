...
{
    public class WhenAccessingItsSteeringsForTheSecondTime : TestBase
    {
        private Repository.Objects.Steering _steering1;
        private Repository.Objects.Steering _steering2;
        private IEnumerable<ISteering> _secondSteerings;
        private IModel _model;
        private ISteeringService _steeringService;
        private IEnumerable<ISteering> _firstSteerings;
        ...
        protected override void Arrange()
        {
            ...
            _firstSteerings = _model.Steerings;
        }

        protected override void Act()
        {
            _secondSteerings = _model.Steerings;
        }

        [Fact]
        public void ThenItShouldFetchNotTheSteeringsFromTheServiceAgain()
        {
        ...
        {
            _secondSteerings.Should().BeSameAs(_firstSteerings);
        }
    }
}
