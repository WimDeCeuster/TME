...
{
    public class WhenAccessingItsStandardOnForTheSecondTime : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            var repoGradePack = new GradePackBuilder()
                .AddStandardOn(_carInfo1)
                .AddStandardOn(_carInfo2)
                .Build();
            ...
            _firstCarInfos = _gradePack.StandardOn;
        }

        protected override void Act()
        {
            _secondCarInfos = _gradePack.StandardOn;
        }
