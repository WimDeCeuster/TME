...
{
    public class WhenAccessingItsNotAvailableOnForTheFirstTime : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            var repoGradePack = new GradePackBuilder()
                .AddNotAvailableOn(_carInfo1)
                .AddNotAvailableOn(_carInfo2)
                .Build();
        ...
        {
            _carInfos = _gradePack.NotAvailableOn;
        }
