...
namespace TME.CarConfigurator.Query.Tests.GivenAnExteriorColour
{
    public class WhenAccessingIts3DAssetsASecondTime : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            _firstAssets = _exteriorColour.VisibleIn.Single(x=> x.Mode == _mode && x.View == _view).Assets;
        }

        protected override void Act()
        {
            _secondAssets = _exteriorColour.VisibleIn.Single(x => x.Mode == _mode && x.View == _view).Assets;
        }
