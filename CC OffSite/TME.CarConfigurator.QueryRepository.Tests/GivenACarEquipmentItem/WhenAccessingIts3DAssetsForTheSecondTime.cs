...
namespace TME.CarConfigurator.Query.Tests.GivenACarEquipmentItem
{
    public class WhenAccessingIts3DAssetsForTheSecondTime : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            _firstAssets = _carEquipment.Options.First().VisibleIn.Single(v => v.Mode == _mode && v.View == _view).Assets;
        }

        protected override void Act()
        {
            _secondAssets = _carEquipment.Options.First().VisibleIn.Single(v => v.Mode == _mode && v.View == _view).Assets;
        }
