...
namespace TME.ColourConfigurator.Query.Tests.Services.GivenAColourService
{
    public class WhenGetColourCombinationsIsCalled : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            A.CallTo(() => keyManager.GetColourCombinationsKey(A<Guid>._, A<Guid>._)).Returns(s3Key);
        ...
        {
            _actualColours = _colourService.GetColourCombinations(Guid.NewGuid(), Guid.NewGuid(), _context);
        }
