...
{
    public class WhenGetCarAssetsIsCalledForNonExistent3DAssets : TestBase
    {
        ...
        {
            _assets = _assetService.GetCarAssets(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), _context, _view, _mode);
        }
