...
{
    public class WhenGetSubModelAssetsIsCalledFor2DAssets : TestBase
    {
        ...
        {
            _actualAssets = _assetService.GetSubModelAssets(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), _context);
        }
