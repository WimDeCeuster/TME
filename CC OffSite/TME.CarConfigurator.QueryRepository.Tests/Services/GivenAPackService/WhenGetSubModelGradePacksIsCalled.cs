...
{
    public class WhenGetSubModelGradePacksIsCalled : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            A.CallTo(() => keyManager.GetSubModelGradePacksKey(A<Guid>._, A<Guid>._, A<Guid>._, A<Guid>._)).Returns(s3Key);
        ...
        {
            _actualPacks = _packService.GetSubModelGradePacks(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), _context);
        }
