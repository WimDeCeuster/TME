...
namespace TME.CarConfigurator.Query.Tests.GivenACarPack
{
    public class WhenAccessingItsRulesForTheFirstTime : TestBase
    {
        ...
        {
            _packRules = _carPack.First().Rules;
        }
        ...
        {
            _packRules.Include.Accessories.First().ShortID.Should().Be(_repoRuleSets.Include.AccessoryRules.First().ShortID);
            _packRules.Include.Options.First().ShortID.Should().Be(_repoRuleSets.Include.OptionRules.First().ShortID);
            _packRules.Include.Packs.First().ShortID.Should().Be(_repoRuleSets.Include.PackRules.First().ShortID);
        }
    }
}