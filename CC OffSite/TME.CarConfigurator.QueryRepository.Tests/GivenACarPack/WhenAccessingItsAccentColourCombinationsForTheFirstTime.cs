...
{
    public class WhenAccessingItsAccentColourCombinationsForTheFirstTime : TestBase
    {
        private IReadOnlyList<ICarPack> _carPack;
        private IReadOnlyList<IAccentColourCombination> _packAccentColourCombinations;
        ...
        {
            _packAccentColourCombinations = _carPack.First().AccentColourCombinations;
        }

        [Fact]
        public void ThenItShouldCalculateThePackAccentColourCombinations()
        {
        ...
        {
            _packAccentColourCombinations.Should()
