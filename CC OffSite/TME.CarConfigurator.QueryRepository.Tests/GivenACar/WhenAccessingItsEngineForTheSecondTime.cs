...
{
    public class WhenAccessingItsEngineForTheSecondTime : TestBase
    {
        ICar _car;
        IEngine _firstEngine;
        IEngine _secondEngine;
        ...
        protected override void Arrange()
        {
            ...
            _firstEngine = _car.Engine;
        }

        protected override void Act()
        {
            _secondEngine = _car.Engine;
        }

        [Fact]
        public void ThenItShouldNotRecalculateTheEngine()
        {
            _secondEngine.Should().Be(_firstEngine);
        }

        [Fact]
        public void ThenTheEngineShouldBeCorrect()
        {
            _secondEngine.ID.Should().Be(_repoEngine.ID);
        }
