...
namespace TME.CarConfigurator.Query.Tests.GivenACarExteriorColour
{
    public class WhenAccessingIts3DAssetsForTheSecondTime : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            A.CallTo(() => _assetService.GetCarAssets(publication.ID, carId, repoCarExteriorColour.ID, context, VIEW, MODE)).Returns(new List<Repository.Objects.Assets.Asset> { _asset1, _asset2 });
            ...
            _firstAssets = _exteriorColour.VisibleIn.Single(vi => vi.Mode == MODE && vi.View == VIEW).Assets;
        }

        protected override void Act()
        {
            _secondAssets = _exteriorColour.VisibleIn.Single(vi => vi.Mode == MODE && vi.View == VIEW).Assets;
        }
