...
{
    public class WhenAccessingItsOptionInfoForTheFirstTime : TestBase
    {
        ...
        {
            _OptionInfo = _carPackOption.ParentOption;
        }

        [Fact]
        public void ThenTheOptionInfoShouldBeCorrect()
        {
            _OptionInfo.ShortID.Should().Be(_repoOptionInfo.ShortID);
        }
    }
}
