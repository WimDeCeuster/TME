...
namespace TME.CarConfigurator.Query.Tests.GivenACarWheelDrive
{
    public class WhenAccessingIts3DAssetsForTheSecondTime : TestBase
    {
        ...
        protected override void Arrange()
        {
            ...
            _firstAssets = _wheelDrive.VisibleIn.Single(visibleIn => visibleIn.Mode == _mode && visibleIn.View == _view).Assets;
        }

        protected override void Act()
        {
            _secondAssets = _wheelDrive.VisibleIn.Single(visibleIn => visibleIn.Mode == _mode && visibleIn.View == _view).Assets;
        }
