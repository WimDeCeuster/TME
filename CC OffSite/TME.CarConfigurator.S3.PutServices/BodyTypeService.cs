...
namespace TME.CarConfigurator.S3.CommandServices
{
    public class BodyTypeService : IBodyTypeService
    {
        ...
        public async Task PutTimeFrameGenerationBodyTypes(String brand, String country, Guid publicationID, Guid timeFrameID, IEnumerable<BodyType> bodyTypes)
        {
            ...
            var path = _keyManager.GetBodyTypesKey(publicationID, timeFrameID);
