...
namespace KellermanSoftware.CompareNetObjects
{
    ...
    public class ComparisonConfig
    {
        ...
        /// <summary>
        /// If true, don't crash on exceptions when accessing properties but add them as a difference.
        /// </summary>
        public bool AllowPropertyExceptions { get; set; }

        /// <summary>
        /// Used when generating bread crumbs and differences. Return null to fall back to the default implementation.
        /// </summary>
        public Func<object, String> CustomStringifier { get; set; }
        ...
        /// </summary>
        public bool DetectMissingAndMisordered { get; set; }
        
        /// <summary>
        /// Member name path to ignore. Don't include indexes.
        /// </summary>
        public List<string> PathsToIgnore { get; set; }

        /// <summary>
        /// The function to use to generate keys for items when comparing unordered lists.
        /// </summary>
        public Dictionary<Type, Func<object, string>> CollectionMatchingKey { get; set; }
