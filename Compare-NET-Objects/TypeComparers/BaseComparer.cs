...
namespace KellermanSoftware.CompareNetObjects.TypeComparers
{
    ...
    public class BaseComparer
    {
        ...
        /// </summary>
        protected void AddDifference(CompareParms parms, string messagePrefix = null, DifferenceType type = DifferenceType.Mismatch)
        {
            Difference difference = new Difference
            {
                ...
                Object1Value = NiceString(parms.Object1, parms.Config.CustomStringifier),
                Object2Value = NiceString(parms.Object2, parms.Config.CustomStringifier),
        ...
        protected string NiceString(object obj, Func<object, String> customStringifier)
        {
            try
            {
                ...
                var customString = customStringifier(obj);
